...
const Faq = () => {
    ...
    return (
        ...
        >
            <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-2xl h-32 sm:h-40 bg-[radial-gradient(ellipse_60%_100%_at_50%_0%,rgba(0,0,0,0.04),transparent_75%)] dark:bg-[radial-gradient(ellipse_60%_100%_at_50%_0%,rgba(0,0,0,0.7),transparent_75%)]" />
