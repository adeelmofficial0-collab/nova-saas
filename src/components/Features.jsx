...
const cardClasses =
    "relative bg-[#0B1220] border border-white/5 rounded-xl p-6 text-left hover:border-blue-500/30 transition-colors duration-300";
...
const Features = () => {
    return (
        ...
        >
            <span
                aria-hidden="true"
                className="pointer-events-none select-none absolute top-10 left-1/2 -translate-x-1/2 text-[8rem] md:text-[12rem] font-black tracking-[0.3em] text-blue-500/[0.06] whitespace-nowrap"
            >
                TRUSTED
            </span>
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mt-16">
